...
import { downloadEmployees } from "../../reducers/downloadEmployeeSlice";
      ...
      <TableRow>
        <TableCell padding="checkbox">
          <Checkbox
            ...
            inputProps={{ "aria-label": "select all Empployees" }}
          />
        </TableCell>
...
const CustomEmployeeTable = ({ rows, screen }) => {
  const classes = useStyles();
  const [order, setOrder] = React.useState("asc");
  const [orderBy, setOrderBy] = React.useState("empid");
...
export default CustomEmployeeTable;
